    ...
    <React.Fragment>
      <Container className={styles.about} id="about">
        ...
        <p>
          ...
          promotes, sells, and propagates southeastern native plants for all
          types of landscapes. We offer a wide variety of native southeastern
          plant life not found in your typical garden center.
        </p>
        ...
        <p>
          ...
          the right native plants in place. Our staff is knowledgeable and eager
          to discuss native plants with all of our customers. If we cannot think
          of the right native option or options for you instantly, we will
          research your situation and get back to you with a response as soon as
          possible.
        </p>
        <p>
          ...
          array of gorgeous native plants available for you. We hope that you
          find our site interesting and educational!
        </p>
      </Container>
